...
beforeAll(async () => {
  ...
  // Seed doctors
  await Doctor.create([
    { name: "Dr Heart", email: "heart@test.com", phone: 9100000001, username: "drheart", password: hash, gender: "male", bio: "Cardiologist", mciNumber: "MCI-H01", department: "Cardiology", experience: 10, profession: ["Cardiologist"], certificate: "dGVzdA==" },
    { name: "Dr Brain", email: "brain@test.com", phone: 9100000002, username: "drbrain", password: hash, gender: "female", bio: "Neurologist", mciNumber: "MCI-N01", department: "Neurology", experience: 8, profession: ["Neurologist"], certificate: "dGVzdA==" },
  ]);

  // Seed admin
  await Admin.create({ name: "Admin", username: "admin_test", email: "admin@test.com", password: hash, role: "admin" });
